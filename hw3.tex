...
\begin{questions}
    ...
    \begin{parts}
        ...
        \solution{%
            The steady-state error between the original Kalman Filter and the new dynamic model is slightly larger even after changing $\mathbf{Q}_d$ for different values.
            \begin{figure}[!h]
                \centering
                \includegraphics[width=\linewidth]{Q4b.png}
