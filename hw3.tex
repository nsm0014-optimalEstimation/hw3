...
\begin{questions}
    ...
    \begin{parts}
        ...
        $\mathbf{Q}_d$ is the discrete process noise and can be evaluated by first finding the discrete dynamic model, $A_d$. We can determine $A_d$ by usings Bryson's trick as seen in Equation \ref{eq:3}.
        \begin{equation}
            \begin{split}
    ...
    \begin{parts}
        ...
        \part{How does the bias estimation compare to least squares solution? How do the bias estimate compare to the Recursive Least Squares solution if you make the covariance ($Q_d$) of the bias estimates equal to zero?}
